...
Route::group(['prefix' => 'api', 'namespace' => 'FI\Modules\API\Controllers'], function ()
{
    ...
    Route::group(['middleware' => 'auth.api'], function ()
    {
        ...
        Route::post('clients/create', ['uses' => 'ApiClientController@create']);
        ...
        Route::post('quotes/create', ['uses' => 'ApiQuoteController@create']);
        ...
        Route::post('invoices/create', ['uses' => 'ApiInvoiceController@create']);
        ...
        Route::post('payments/create', ['uses' => 'ApiPaymentController@create']);
