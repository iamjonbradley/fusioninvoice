...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            {!! Form::select('invoice_template', $invoiceTemplates, ((isset($client)) ? $client->invoice_template : config('fi.invoiceTemplate')), ['id' => 'invoice_template', 'class' => 'form-control']) !!}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <label>{{ trans('fi.default_quote_template') }}: </label>
            {!! Form::select('quote_template', $quoteTemplates, ((isset($client)) ? $client->quote_template : config('fi.quoteTemplate')), ['id' => 'quote_template', 'class' => 'form-control']) !!}
        </div>
    </div>
</div>
