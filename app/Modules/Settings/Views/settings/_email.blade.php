...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="help-block"><a href="https://www.fusioninvoice.com/docs/2017/Customization/Email-Templates#quote-email-template" target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <span class="help-block"><a href="https://www.fusioninvoice.com/docs/2017/Customization/Email-Templates#invoice-email-template" target="_blank">{{ trans('fi.available_fields') }}</a></span>
        </div>
    </div>
</div>
...
<div class="form-group">
    ...
    <span class="help-block"><a href="https://www.fusioninvoice.com/docs/2017/Customization/Email-Templates#payment-receipt-email-template" target="_blank">{{ trans('fi.available_fields') }}</a></span>
</div>
