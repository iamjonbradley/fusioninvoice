...
class RecurringInvoiceTables extends Migration
{
    ...
    public function down()
    {
        ...
        Schema::drop('recurring_invoice_amounts');
        Schema::drop('recurring_invoice_items');
        Schema::drop('recurring_invoice_item_amounts');

        Schema::rename('recurring_invoices_old', 'recurring_invoices');
    }
}
