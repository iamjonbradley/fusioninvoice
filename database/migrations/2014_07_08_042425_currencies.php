...
class Currencies extends Migration {
    ...
    public function up()
    {
        ...
        App::make('FI\Modules\Settings\Repositories\SettingRepository')->save('baseCurrency', 'USD');
        App::make('FI\Modules\Settings\Repositories\SettingRepository')->save('exchangeRateMode', 'automatic');
    }
