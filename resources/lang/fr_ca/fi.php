...
return [
    ...
    'activity_quote_approved'                 => 'Le Soumission <a href=":link">#:number</a> a été approuvé.',
    'activity_quote_rejected'                 => 'Le Soumission <a href=":link">#:number</a> a été rejeté.',
    'activity_quote_viewed'                   => 'Le Soumission <a href=":link">#:number</a> a été consulté.',
    ...
    'always_bcc'                              => 'Toujours insérer ce courriel en CCI ',
    'always_cc'                               => 'Toujours insérer ce courriel en CC ',
    'amount'                                  => 'Montant ',
    'api_public_key'                          => 'Clé API publique ',
    'api_secret_key'                          => 'Clé API secrète ',
    'approve'                                 => 'Approuver',
    'approved'                                => 'Approuvé',
    'approved_quotes'                         => 'Soumission approuvés',
    'attach_files'                            => 'Joindre une pièce',
    'attach_pdf'                              => 'Joindre le PDF',
    'attachment'                              => 'Pièce jointe',
    'attachments'                             => 'Pièces jointes',
    'author'                                  => 'Auteur',
    'automatic'                               => 'Automatique',
    'automatic_email_on_recur'                => 'Envoi automatisé des factures récurrentes par courriel ',
    'automatic_email_payment_receipts'        => 'Envoi automatisé des reçus de paiement par courriel ',
    'available_fields'                        => 'Liste des champs disponibles ',
    'back'                                    => 'Retour',
    'back_to_invoice'                         => 'Retour à la facture',
    'back_to_quote'                           => 'Retour au Soumission',
    'balance'                                 => 'Solde restant à payer ',
    'base_currency'                           => 'Soumissione utilisée par défault ',
    'bcc'                                     => 'CCI',
    ...
    'confirm_approve_quote'                   => 'Êtes-vous sûr de vouloir approuver ce Soumission ?',
    'confirm_reject_quote'                    => 'Êtes-vous sûr de vouloir rejeter ce Soumission ?',
    'continue'                                => 'Continuer',
    'convert_quote_option1'                   => 'La facture doit récupérer les termes de la Soumission',
    'convert_quote_option2'                   => 'La facture doit récupérer les termes par défaut',
    'convert_quote_setting'                   => 'Quand une Soumission est converti en facture ',
    'convert_quote_when_approved'             => 'Convertir automatiquement les Soumissions en factures lorsque le client a approuvé ',
    'converted_from_quote'                    => 'Converti depuis la Soumission',
    ...
    'default_currency'                        => 'Soumissione utilisée par défaut ',
    'default_footer'                          => 'Pied de page par défaut ',
    'default_group'                           => 'Groupe par défaut ',
    'default_invoice_email_body'              => 'Courriel par défaut pour l\'envoi des factures ',
    ...
    'default_overdue_invoice_email_body'      => 'Courriel par défaut pour les relances de factures impayées ',
    'default_payment_receipt_body'            => 'Courriel par défaut pour l\'envoi des reçus de paiement ',
    'default_quote_email_body'                => 'Courriel par défaut pour l\'envoi des Soumissions ',
    'default_quote_template'                  => 'Modèle de Soumission par défaut ',
    'default_terms'                           => 'Termes par défaut ',
    'delete'                                  => 'Supprimer',
    'delete_client_warning'                   => 'Si vous supprimez ce client, vous supprimerez également les factures, soumissions et paiements attachés. Êtes-vous sûr de vouloir supprimer ce client ?',
    ...
    'draft_quotes'                            => 'Soumissions brouillons',
    ...
    'email_payment_receipt'                   => 'Envoyer le reçu du paiement par courriel',
    'email_quote'                             => 'Envoyer la Soumission',
    'email_send_method'                       => 'Méthode d\'envoi des courriels ',
    ...
    'export_quote_items'                      => 'Exporter la liste des articles soumissionés',
    'export_quotes'                           => 'Exporter la liste des soumissions créés',
    'fax'                                     => 'Fax ',
    'fax_number'                              => 'Fax ',
    ...
    'help_text_client_name'                   => 'Ce champ doit contenir le nom de votre client tel qu\'il doit apparaitre sur vos soumissions et factures.',
    'help_text_client_password'               => 'Laissez ce champ vide, sauf si vous souhaitez créer ou modifier le mot de passe.',
    'help_text_client_unique_name'            => 'Lorsque plusieurs de vos clients ont le même nom, le nom unique vous permettra de les différencier. Ce nom n\'apparait pas sur les soumissions et factures.',
    'i_accept'                                => 'J\'accepte',
    ...
    'invoice_email_subject'                   => 'Objet des courriels pour l\'envoi des factures ',
    ...
    'logo'                                    => 'Logo ',
    'mail_hash_error'                         => 'Il semblerait que votre clé secrète ait été modifiée depuis le dernier enregistrement de votre mot de passe. Pour corriger cette erreur, rendez-vous dans Réglages -> onglet Courriel, re-saisissez votre mot de passe puis enregistrez. Aucun courriel ne pourra être envoyé tant que cela n\'aura pas été corrigé.',
    'manual'                                  => 'Manuel',
    ...
    'monthly'                                 => 'Chaque mois',
    'months'                                  => 'Mois',
    'multiple_email_validation'               => 'Les adresses courriels doivent être valides et séparées par des virgules.',
    'name'                                    => 'Nom ',
    ...
    'overdue'                                 => 'Échue',
    'overdue_email_subject'                   => 'Objet des courriel pour l\'envoi des relances de factures impayées ',
    ...
    'payment_receipt_email_subject'           => 'Objet des courriels pour l\'envoi des reçus de paiement ',
    'payments'                                => 'Paiements',
    ...
    'price'                                   => 'Prix unit.',
    'private'                                 => 'Privé',
    'problem_with_email_template'             => 'Il semble y avoir un problème avec le modèle de courriel. Merci de vérifier vos modèles depuis le menu Réglages > onglet Courriel.',
    'product'                                 => 'Article',
    ...
    'quote_approved_email_body'               => 'Courriel par défault lorsqu\'une soumission est approuvée ',
    'quote_default'                           => 'Soumission par défaut',
    'quote_email_subject'                     => 'Objet des courriels pour l\'envoi des soumissions ',
    'quote_items'                             => 'Articles Soumissionés',
    'quote_number'                            => 'Numéro du Soumission',
    'quote_rejected'                          => 'Soumission rejetée',
    'quote_rejected_email_body'               => 'Courriel par défault lorsqu\'une Soumission est rejetée ',
    'quote_status_change_notification'        => 'Notification: Quote Status Change',
    'quote_summary'                           => 'Soumission',
    'quote_to_invoice'                        => 'Soumission en facture',
    'quotes'                                  => 'Soumission',
    'quotes_expire_after'                     => 'Durée de validité des Soumissions (en jours) ',
    ...
    'recalculate_quotes'                      => 'Recalculer les Soumissions ',
    ...
    'recent_quotes'                           => 'Soumission récentes',
    ...
    'reject'                                  => 'Rejeter',
    'rejected'                                => 'Rejeté',
    'rejected_quotes'                         => 'Soumissions rejetées',
    ...
    'round_tax_decimals'                      => 'Nombre de décimales pour la Taxe ',
    ...
    'sent_quotes'                             => 'Soumission envoyés',
    'settings'                                => 'Paramètres',
    ...
    'tax_rate_form'                           => 'Édition d\'un taux de Taxe',
    ...
    'upcoming_payment_notice_email_body'      => 'Courriel par défaut pour l\'envoi des avis de paiement ',
    ...
    'validation_quote_summary_to_date'        => 'À ce jour, le Widget Dashboard Résumé des Soumission est requis lorsque vous utilisez une plage de dates personnalisée.',
    'vendor'                                  => 'Vendeur ',
    'version'                                 => 'Version ',
    'view'                                    => 'Voir',
    ...
    'view_all_quotes_for_client'              => 'Voir tous les Soumission de ce client',
    'view_approved_quotes'                    => 'Voir les Soumission approuvés',
    'view_client'                             => 'Aperçu du client',
    'view_draft_invoices'                     => 'Voir les factures brouillons',
    'view_draft_quotes'                       => 'Voir les Soumission brouillons',
    'view_overdue_invoices'                   => 'Voir les factures échues',
    'view_payments'                           => 'Voir les paiements reçus',
    'view_rejected_quotes'                    => 'Voir les Soumission rejetés',
    'view_sent_invoices'                      => 'Voir les factures récurrentes',
    'view_sent_quotes'                        => 'Voir les Soumission envoyés',
    ...
    // Added for 2017-1
    'all_company_profiles'                    => 'Tous les compagnies',
    'allow_payments_without_balance'          => 'Permettre l\'entrée de paiements sur les factures sans solde',
    'cannot_delete_record_in_use'             => 'Cet enregistrement est en cours d\'utilisation et ne peut pas être supprimé.',
    'cannot_edit_record_in_use'               => 'Cet enregistrement est en cours d\'utilisation et ne peut pas être édité.',
    'change_company_profile'                  => 'Changer le profil de l\'entreprise',
    'company_profile'                         => 'Profil de l\'entreprise',
    'company_profiles'                        => 'Profil des entreprises',
    ...
    'fourth_quarter'                          => 'Quatrième Quart',
    'id'                                      => 'ID',
